            ...
            <div className="w-full p-12 bg-gray-50 h-full">
              ...
              <form>
                <div className="flex text-center">
                  <div
                    className="w-full border-b-2 py-2 cursor-pointer font-semibold text-gray-600 hover:text-black active:text-vto-400"
                    onClick={() => setActive("EmailFragment")}
                  >
                    EMAIL
                  </div>
                  <div
                    className="w-full border-b-2 py-2 cursor-pointer font-semibold text-gray-600 hover:text-black focus:text-vto-400"
