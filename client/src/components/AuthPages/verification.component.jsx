          ...
          <div className="text-black my-2 flex justify-center items-center">
            <div className="w-full py-12 px-12 bg-gray-50 h-full">
              ...
              <div className='text-sm text-gray-500'>
                Please validate the verification code we sent you by email/message.
              </div>
              ...
              <form>
                <div className="mt-12">
                    ...
                    <div className="flex items-center gap-2 mt-12">
                        <button className="w-full text-vto-400 px-3 py-2 border-2 border-vto-400 text-lg rounded-md bg-white hover:bg-vto-50" onClick={e => setOtp([...otp.map(v => "")])}>Clear</button>
                        <button className="w-full text-white px-3 py-2 border-2 border-vto-400 text-lg rounded-md bg-vto-400 hover:bg-vto-500" type="submit">Verify</button>
                    </div>
                </div>
              </form>
