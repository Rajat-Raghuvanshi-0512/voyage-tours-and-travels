    ...
    <div {...props}>
      <div className="absolute -right-10 z-10 mt-2 w-64 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none p-4">
        <div className="py-1 w-full">
          <div>
            <h6 className="capitalize font-[400] font-poppins">
              Hey traveller
            </h6>
          ...
          {isAuthenticated === false && (
            <div className="flex justify-center">
              <button
                className="rounded bg-[#FF8227] text-sm text-white font-light px-7 py-2 my-4 hover:scale-95 hover:bg-[#f86f0d] duration-300"
